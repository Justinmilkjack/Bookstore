						...
						<div class="content-top">
							 ...
							 <div class="text"> 	
								<div class="grid_1_of_3 images_1_of_3">
									<div class="grid_1">
										<a href="single.html"><img src="${b.bookImg }" title="continue reading" alt="" height="170" width="170"></a>
											<div class="grid_desc">
							...
							共${page.totalRecords}条记录 共${page.totalPages}页 当前第${page.pageno}页
									<!-- <div class="grid_1_of_3 images_1_of_3">
										  <div class="grid_1">
										<a href="single.html"><img src="books/literature/追风筝的人.jpg" title="continue reading" alt="" height="170" width="170"></a>
											<div class="grid_desc">
												<p class="title">Lorem ipsum dolor sitconsectetuer adipiscing elit</p>
												<p class="title1">Lorem ipsum dolor sitconsectetuer adipiscing elit</p>
													 <div class="price" style="height: 19px;">
